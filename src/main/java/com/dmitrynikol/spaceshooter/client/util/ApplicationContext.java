...
public class ApplicationContext
{
  ...
  public static void runPowerups( final Spaceship spaceship, final Powerup powerup )
  {
    ...
    {
      case FREEZE:
        ApplicationContext.setFreezeEnabled( true );
        break;
      case REFLEX_BOOST:
        ApplicationContext.setReflexBoostEnabled( true );
        break;
      case SHIELD:
        ApplicationContext.setShieldEnabled( true );
        break;
      case DOUBLE_EXP:
        ApplicationContext.setScoreIncrease( 2 );
        break;
      case MEDIKIT:
    ...
    final Timer timer = new Timer()
    {
      ...
      public void run()
      {
        ...
        {
          case FREEZE:
            ApplicationContext.setFreezeEnabled( false );
            break;
          case REFLEX_BOOST:
            ApplicationContext.setReflexBoostEnabled( false );
            break;
          case SHIELD:
            ApplicationContext.setShieldEnabled( false );
            break;
          case DOUBLE_EXP:
            ApplicationContext.setScoreIncrease( 1 );
            break;
          default:
            break;
        }
